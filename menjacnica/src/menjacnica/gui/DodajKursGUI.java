		...
		if (btnDodaj == null) {
			...
			btnDodaj.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					(textFieldNaziv.getText(),textFieldSkraceniNaziv.getText(),
					(Integer)(spinnerSifra.getValue()),textFieldProdajniKurs.getText(),textFieldKupovniKurs.getText(),textFieldSrednjiKurs.getText());
